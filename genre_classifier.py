...
def prepare_datasets(test_size, validation_size):
    ...
    X_test = X_test.reshape(-1, num_time_steps * num_mfcc)
    ...
    X_train = X_train.reshape(-1, num_time_steps, num_mfcc, 1)
    X_validation = X_validation.reshape(-1, num_time_steps, num_mfcc, 1)
    X_test = X_test.reshape(-1, num_time_steps, num_mfcc, 1)
